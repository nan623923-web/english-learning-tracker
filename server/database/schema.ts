...
export const studyCheckins = pgTable("study_checkins", {
  ...
  uniqueIndex("study_checkins_owner_date_unique").on(table.ownerUserId, table.studyDate),
]);

// table aliases
export const studyCheckinsTable = studyCheckins;
